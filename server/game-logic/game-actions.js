 ...
 * @returns {object} The updated game state.
 */
const handleStageSingleCardFromHand = (gameState, card) => {
  const { playerHands, tableCards, currentPlayer } = gameState;
 ...
 * @returns {object} The updated game state.
 */
const handleFinalizeTrail = (gameState, stack) => {
  const { tableCards, currentPlayer } = gameState;
 ...
 * @returns {object} The updated game state.
 */
const handleExtendToMerge = (gameState, handCard, opponentBuild, ownBuild) => {
  const { playerHands, tableCards, currentPlayer } = gameState;
